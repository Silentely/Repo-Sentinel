...
type aiConfigResponse struct {
	...
	FailureAnalysisEnabled bool   `json:"failure_analysis_enabled"`
	...
	FailureAnalysisEnabledSource string `json:"failure_analysis_enabled_source"`
	...
	FailureAnalysisEnabledLocked bool `json:"failure_analysis_enabled_locked"`
...
func (s *server) handleGetAIConfig(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, aiConfigResponse{
		...
		FailureAnalysisEnabledSource: snap.FailureAnalysisEnabledSource,
		...
		FailureAnalysisEnabledLocked: snap.FailureAnalysisEnabledSource == "env",
		CanEditInUI:                  true,
...
func (s *server) handlePutAIConfig(w http.ResponseWriter, r *http.Request) {
	...
	if body.FailureAnalysisEnabled != nil {
		if s.rejectAILockedField(w, r, snap.FailureAnalysisEnabledSource, "failure_analysis_enabled") {
			return
		}
		stored.FailureAnalysisEnabled = body.FailureAnalysisEnabled
	}
	if body.APIKey != nil {
