...
func (*AuditLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case auditlog.FieldMetadataJSON:
			values[i] = new([]byte)
		case auditlog.FieldID, auditlog.FieldAction, auditlog.FieldActorType, auditlog.FieldActorID, auditlog.FieldTargetType, auditlog.FieldTargetID, auditlog.FieldIPAddress:
