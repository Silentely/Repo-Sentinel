...
func (_c *SystemSettingCreate) SetUpdatedBy(v string) *SystemSettingCreate {
...
func (_c *SystemSettingCreate) check() error {
	...
	if _, ok := _c.mutation.ValueJSON(); !ok {
		return &ValidationError{Name: "value_json", err: errors.New(`ent: missing required field "SystemSetting.value_json"`)}
	}
