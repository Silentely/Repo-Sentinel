...
| 时间戳 (UTC) | 变更摘要 |
|---|---|
| 2026-09-25T10:20:00Z | 优化 PR 审查跟踪键与风险通知消息组装：reviewKey/reviewKeyPrefix 改用原生字符串拼接与 strconv 消除 fmt.Sprintf 堆分配与反射装箱；enqueueRiskNotification 预分配 StringBuilder 容量并消除标题/正文的 fmt.Sprintf 格式化开销 |
