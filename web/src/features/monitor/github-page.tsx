    ...
    <>
      ...
      <section className="onboarding-card" aria-labelledby="gh-webhook-title">
        ...
        <div className="link-row">
          <a className="quiet-button" href={GITHUB_NEW_APP} target="_blank" rel="noopener noreferrer" title="在新窗口打开"><ExternalLink size={14} aria-hidden="true" /> 创建 GitHub App</a>
          <a className="quiet-button" href={DOCS_GITHUB_APP} target="_blank" rel="noopener noreferrer" title="在新窗口打开"><ExternalLink size={14} aria-hidden="true" /> 部署文档</a>
        </div>
      </section>
      ...
      <section className="onboarding-card" aria-labelledby="gh-install-action-title">
        ...
        <div className="link-row">
          <a className="primary-button primary-button--inline" href={GITHUB_INSTALLATIONS} target="_blank" rel="noopener noreferrer" title="在新窗口打开"><ExternalLink size={15} aria-hidden="true" /> 去 GitHub 安装 / 管理 App</a>
          <a className="quiet-button" href={GITHUB_APPS_SETTINGS} target="_blank" rel="noopener noreferrer" title="在新窗口打开"><ExternalLink size={14} aria-hidden="true" /> 我的 GitHub Apps</a>
      ...
      <section className="onboarding-card" aria-labelledby="gh-install-title">
        <div className="onboarding-card__header">
          ...
          <div className="link-row">
            ...
            <a className="quiet-button" href={GITHUB_INSTALLATIONS} target="_blank" rel="noopener noreferrer" title="在新窗口打开"><ExternalLink size={14} aria-hidden="true" /> 去 GitHub 安装</a>
          </div>
        </div>
              ...
              {items.map((inst) => (
                <li key={inst.id}>
                  ...
                  {inst.installation_id > 0 ? (
                    <a className="quiet-button" href={`https://github.com/settings/installations/${inst.installation_id}`} target="_blank" rel="noopener noreferrer" title="在新窗口打开">配置</a>
                  ) : null}
                </li>
              ))}
            </ul>
